...
export class SightTypeCaruselComponent implements OnInit {
  ...
  constructor(private sightTypeService: SightTypeService) {}

  scrollLeft() {
    this.wigetSightScroll.nativeElement.scrollTo({
      left: this.wigetSightScroll.nativeElement.scrollLeft - this.scroll,
      behavior: 'smooth',
    })
  }
  scrollRight() {
