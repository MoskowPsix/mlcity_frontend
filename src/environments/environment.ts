...
export const environment = {
  ...
  DOMAIN: 'localhost',
  appleClientId: 'mlcity.ru',
  appleAuthUrl: 'http://localhost:8001/api/social-auth/apple',
  vkontakteAuthUrl: `http://localhost:8001/api/social-auth/vkontakte`,
  yandexAuthUrl: 'http://localhost:8001/api/social-auth/yandex/',
  vkontakteServiceKey: '7c6d50047c6d50047c6d5004647f7f17fc77c6d7c6d50041fa47869a3cc84a7c0bed429',
  // cityName: 'Заречный',
  // cityRegion: 'Свердловская область',
  // cityCoordsLatitude: 56.81497464978607,
